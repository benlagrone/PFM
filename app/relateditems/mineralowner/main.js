...
/* Mineralowners list */
/* load the Mineralowners list into here */
var tempList = [];
...
function leasecheckMineralownerRelatedItemsVM(type) {
    ...
    var relatedArray = [
        {id: "Mineralowners", label: "Mineralowners"},
...
function getData(itemList, type) {
    ...
    switch (type) {
        case "Tracts":
            masterVM.relatedType("Related Mineralowner");
